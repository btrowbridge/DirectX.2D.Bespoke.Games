...
namespace AngryBox2DGame {
	...
	{
		//TODO:
		//use game instance of xmlreader to parse definition file
		IStream *pFileStream = NULL; 
		IXmlReader *pReader = mGame->As<AngryBox2D>()->XMLReader();
		...
		//if (ThrowIfFailed(hr = SHCreateStreamOnFile(argv[1], STGM_READ, &pFileStream))) 
		//{ 
