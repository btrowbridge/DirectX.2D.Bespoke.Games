...
int WINAPI WinMain(HINSTANCE instance, HINSTANCE previousInstance, LPSTR commandLine, int showCommand)
{
	...
	static const wstring windowClassName = L"BouncingLogoClass";
	static const wstring windowTitle = L"Bouncing Logo!";
	...
	mGame = make_unique<BouncingLogoGame>(getWindow, getRenderTargetSize);
