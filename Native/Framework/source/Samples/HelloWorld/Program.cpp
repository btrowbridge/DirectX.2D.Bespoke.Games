...
int WINAPI WinMain(HINSTANCE instance, HINSTANCE previousInstance, LPSTR commandLine, int showCommand)
{
	...
	static const wstring windowClassName = L"HelloWorldClass";
	static const wstring windowTitle = L"Hello, World!";
	...
	mGame = make_unique<HelloWorldGame>(getWindow, getRenderTargetSize);
