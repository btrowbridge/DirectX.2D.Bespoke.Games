...
using namespace SimpleCollision;
using namespace std;
...
int WINAPI WinMain(HINSTANCE instance, HINSTANCE previousInstance, LPSTR commandLine, int showCommand)
{
	...
	static const wstring windowClassName = L"SimpleSimpleCollisionClass";
	static const wstring windowTitle = L"SimpleCollision";
	...
	mGame = make_unique<SimpleCollisionGame>(getWindow, getRenderTargetSize);
